...
| 参数 | 类型 | 必填 | 说明 |
|------|------|------|------|
| `status` | string | 否 | `upcoming/running/ended` |
| `page` | int | 否 | 页码，默认1 |
...
```json
{
  "teamName": "string (团队赛必填)",
  "teamMembers": ["userId1", "userId2"] (团队赛必填)
}
```
...
```json
{
  ...
  "data": {
    ...
    "team": {
      ...
      "name": "梦之队",
      "members": [
        {"id": 1, "username": "jacky", "role": "captain"},
        {"id": 2, "username": "tom", "role": "member"}
      ]
    }
  }
}
